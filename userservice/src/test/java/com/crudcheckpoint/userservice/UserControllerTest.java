...
public class UserControllerTest {
    ...
    public void testGetUserByIdNotFound() throws Exception {
        ...
        RequestBuilder request = get("/users/{id}", 3);
        this.mvc.perform(request)
                .andExpect(status().isOk())
    ...
    public void testDeleteUserByInvalidId() throws Exception {
        RequestBuilder request = delete("/users/{id}", 3);
        this.mvc.perform(request)
                .andExpect(status().isOk())
    ...
    @Transactional
    @Rollback
    public void testUpdateUserOnlyEmail() throws Exception {
    ...
    @Transactional
    @Rollback
    public void testUpdateUserEmailAndPassword() throws Exception {
    ...
    @Test
    public void testSuccessAuthenticateUser() throws Exception {
